...
class MetisClass(TemplateMetis):
    """
        object for android and ios script.
    """
    ...
    def __init__(self,
        ...
        super(TemplateMetis, self).__init__()
    ...
    def _send_image_path_to_ui(self, _image_path: str):
        if self._ui_label_dict:
            ...
            self.qimg = QImage(self._pyqt_img, _width, _height, _bytes_perline,
